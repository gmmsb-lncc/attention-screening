...
BENCHMARK_MLP_CALIBRATE_MEMBERS="${BENCHMARK_MLP_CALIBRATE_MEMBERS:-1}"
...
export BENCHMARK_MLP_CALIBRATE_MEMBERS
...
echo " MLP per-member calibration: ${BENCHMARK_MLP_CALIBRATE_MEMBERS}"
