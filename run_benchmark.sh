...
# Level 4 CNN precision control.
BENCHMARK_LEVEL4CNN_DOUBLE="${BENCHMARK_LEVEL4CNN_DOUBLE:-1}"            # float64 (2x memory, 2x slower)
BENCHMARK_LEVEL4CNN_NO_AMP="${BENCHMARK_LEVEL4CNN_NO_AMP:-0}"            # disable mixed precision (float32 only)
BENCHMARK_LEVEL4CNN_DETERMINISTIC="${BENCHMARK_LEVEL4CNN_DETERMINISTIC:-0}"  # reproducible results (20-30% slower)

# Level 4 CNN BAN (Bilinear Attention Network) variant.
# v7 = original dot-product (projects both embeddings to head_dim before interaction)
# v8 = full bilinear (W[prot_dim, lig_dim] per head, no projection bottleneck)
BENCHMARK_LEVEL4CNN_VARIANT="${BENCHMARK_LEVEL4CNN_VARIANT:-v7}"
BENCHMARK_LEVEL4CNN_BATCH_SIZE="${BENCHMARK_LEVEL4CNN_BATCH_SIZE:-256}"
BENCHMARK_LEVEL4CNN_NUM_HEADS="${BENCHMARK_LEVEL4CNN_NUM_HEADS:-8}"
BENCHMARK_LEVEL4CNN_HEAD_DIM="${BENCHMARK_LEVEL4CNN_HEAD_DIM:-32}"
BENCHMARK_LEVEL4CNN_CHANNELS="${BENCHMARK_LEVEL4CNN_CHANNELS:-64}"
BENCHMARK_LEVEL4CNN_DROPOUT="${BENCHMARK_LEVEL4CNN_DROPOUT:-0.3}"
BENCHMARK_LEVEL4CNN_WEIGHT_DECAY="${BENCHMARK_LEVEL4CNN_WEIGHT_DECAY:-0.02}"
...
export BENCHMARK_LEVEL4CNN_DOUBLE
export BENCHMARK_LEVEL4CNN_NO_AMP
export BENCHMARK_LEVEL4CNN_DETERMINISTIC
export BENCHMARK_LEVEL4CNN_VARIANT
export BENCHMARK_LEVEL4CNN_BATCH_SIZE
export BENCHMARK_LEVEL4CNN_NUM_HEADS
export BENCHMARK_LEVEL4CNN_HEAD_DIM
export BENCHMARK_LEVEL4CNN_CHANNELS
export BENCHMARK_LEVEL4CNN_DROPOUT
export BENCHMARK_LEVEL4CNN_WEIGHT_DECAY
...
echo " Level4 CNN precision: double=${BENCHMARK_LEVEL4CNN_DOUBLE}, no_amp=${BENCHMARK_LEVEL4CNN_NO_AMP}, deterministic=${BENCHMARK_LEVEL4CNN_DETERMINISTIC}"
echo " Level4 CNN variant: ${BENCHMARK_LEVEL4CNN_VARIANT} (v7=dot-product, v8=BAN), batch_size=${BENCHMARK_LEVEL4CNN_BATCH_SIZE}"
echo " Level4 CNN arch: heads=${BENCHMARK_LEVEL4CNN_NUM_HEADS}, head_dim=${BENCHMARK_LEVEL4CNN_HEAD_DIM}, channels=${BENCHMARK_LEVEL4CNN_CHANNELS}, dropout=${BENCHMARK_LEVEL4CNN_DROPOUT}, wd=${BENCHMARK_LEVEL4CNN_WEIGHT_DECAY}"
