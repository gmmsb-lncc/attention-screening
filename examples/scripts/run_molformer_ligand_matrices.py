#!/usr/bin/env python3
"""
Script para gerar matrizes de embedding de ligantes usando MoLFormer
para o conjunto de dados de compostos não humanos.
"""
...
def run_molformer_pipeline():
    """Executar o pipeline com MoLFormer para gerar matrizes de ligantes."""
...
if __name__ == "__main__":
    ...
    success = run_molformer_pipeline()
