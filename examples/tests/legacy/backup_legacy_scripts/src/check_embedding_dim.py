...
protein_embedding_file = "${PROJECT_ROOT}/non_humans/protein_embeddings/10030_protein_embedding.npy"
if os.path.exists(protein_embedding_file):
    ...
    ligand_embedding_file = "${PROJECT_ROOT}/non_humans/ligand_embeddings/10030_ligand.npy"
