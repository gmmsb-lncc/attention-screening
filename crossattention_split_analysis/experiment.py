...
def run_single_analysis(
    ...
    Args:
        ...
        model_variant: 'cnn_crossattn' or 'cross_attention_lite'
    ...
    variant_prefix = 'lite_' if model_variant == 'cross_attention_lite' else ''
    prefix = f"{dataset_type}_{variant_prefix}{attn_prefix}{molformer_prefix}{short_name}_"
