...
# `attention-screening-results` bundle (identical in diamante-02 and
...
V7_CKPT_HUMAN="${V7_CKPT_HUMAN:-results/attention-screening-results/dt-kinase/benchmark_human_8M_01_04_2026/test/level4_cnn_8M/human}"
V7_CKPT_NON_HUMAN="${V7_CKPT_NON_HUMAN:-results/attention-screening-results/dt-kinase/benchmark_non_human_8M_13_05_2026/test/level4_cnn_8M/non_human}"
V7_CKPT_ALL="${V7_CKPT_ALL:-results/attention-screening-results/dt-kinase/benchmark_all_8M_13_04_2026/test/level4_cnn_8M/all}"
