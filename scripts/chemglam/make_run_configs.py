...
def main() -> int:
    ...
    run_name = f"chemglam_{args.corpus}_seed{args.seed}"
    ...
    train.update(
        ...
        cache_dir=f"chemglam_{args.corpus}",
        dataset_csv_path=f"data/chemglam/{args.corpus}/train_valid.csv",
        split_json_path=f"data/chemglam/{args.corpus}/train_valid_split.json",
