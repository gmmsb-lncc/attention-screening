...
def main():
    """Main entry point."""
    input_path = Path('/media/leon/ssd2tb/docktkinase/ablation/classification/data/processed/ligands.csv')
    output_path = Path('/media/leon/ssd2tb/docktkinase/ablation/classification/data/embeddings/morgan_fp.npy')
