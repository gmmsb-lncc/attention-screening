...
def save_benchmark_json(
    ...
    output = {
        "metadata": {
            ...
            "use_esmfold_protein": config.use_esmfold_protein,
            "esmfold_features_dir": config.esmfold_features_dir,
            "esmfold_default_dirs": config.resolved_esmfold_feature_dirs,
