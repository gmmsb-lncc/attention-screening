...
### Stratification
```python
STRATIFICATION_DEFAULT_CLUSTERING_ALGORITHM = 'kmeans'  # MiniBatchKMeans with k-means++ seeding
STRATIFICATION_DEFAULT_SIMILARITY_THRESHOLD = None       # Deprecated (not used by k-means flow)
