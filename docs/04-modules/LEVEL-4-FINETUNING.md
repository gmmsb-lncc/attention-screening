...
python attention_screening_models.py --dataset human --embedding 8M --levels 4 --finetune_epochs 10

# PASSO 2: Extrair embeddings fine-tuned (Level 0)
python attention_screening_models.py --dataset human --embedding 8M --levels 0 --use_finetuned

# PASSO 3: Treinar downstream (Levels 2-3)
python attention_screening_models.py --dataset human --embedding 8M --levels 2 3 --use_finetuned
