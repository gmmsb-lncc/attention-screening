...
### ESM-3 / ESM-C Models (EvolutionaryScale)

| Model | Parameters | Embedding Dim | Speed | Notes |
|-------|------------|---------------|-------|-------|
| `esmc-300m-2024-12` | 300M | 960 | ⚡⚡ Fast | Local |
| `esmc-600m-2024-12` | 600M | 1152 | ⚡ Medium | Local |
| `esmc-6b-2024-12` | 6B | 4096 | Slow | API only |

**Key differences from ESM-2**: ESM-C uses causal (next-token) prediction instead of masked language modeling, which can better capture generative protein grammar and long-range dependencies.
