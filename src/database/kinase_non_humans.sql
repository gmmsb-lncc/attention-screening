...
-- Criando a tabela smile_kinase_non_human_compounds

CREATE TABLE public.smile_kinase_non_human_compounds AS
SELECT DISTINCT
...
\COPY public.smile_kinase_non_human_compounds TO '/home/leon/Desktop/kinase_non_human_compounds.tsv' WITH (FORMAT csv, HEADER, DELIMITER E'\t');